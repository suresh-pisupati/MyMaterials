package com.suresh.businessrules.database.config;
...
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "com.suresh.businessrules.repository", entityManagerFactoryRef = "businessRulesEntityManager", transactionManagerRef = "businessRulesTransactionManager")
public class BusinessRulesPersistenceConfiguration {
   ...
   public LocalContainerEntityManagerFactoryBean businessRulesEntityManagerFactory( EntityManagerFactoryBuilder builder ) {
      ...
      return builder.dataSource( oipaDataSource() ).properties( applicationProperties() ).packages( BusinessRulesEntity.class ).persistenceUnit( "businessRulesPU" ).build();
   }
